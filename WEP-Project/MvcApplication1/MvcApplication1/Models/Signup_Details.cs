...
namespace MvcApplication1.Models
{
    public class Signup_Details
    {
        ...
        public void Details(String name, String email, String uname, String pswd, String mobile)
        {
            ...
            SqlCommand Check_Email = new SqlCommand("Select count(Email) from SignUp where Email = '"+ email+"' ", Con);
            SqlCommand Check_Username = new SqlCommand("Select count(Username) from SignUp where Username = '" + uname + "' ", Con);
            SqlCommand Registration_Details = new SqlCommand("Insert into SignUp values ('" + name + "', '" + email + "', '" + uname + "',  '" + enctpass + "', '" + mobile + "' );", Con);
