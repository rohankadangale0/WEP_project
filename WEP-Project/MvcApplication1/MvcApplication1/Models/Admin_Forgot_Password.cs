...
namespace MvcApplication1.Models
{
    public class Admin_Forgot_Password
    {
        ...
        public void generate_password(String uname, String email)
        {
            ...
            SqlCommand check_email = new SqlCommand("Select count(Email) from admin where Username = '" + uname + "' AND Email = '" + email + "' ", Con);
            ...
            if (verify_username == 1)
            {
                ...
                if (verify_email == 1)
                {
                    ...
                    SqlCommand updated_generated_password = new SqlCommand("Update admin set Password = '" + encrptpass + "' where Username = '" + uname + "' AND Email = '" + email + "' ", Con);
