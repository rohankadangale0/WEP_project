...
<head runat="server">
    ...
    <script runat="server">
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            System.Data.SqlClient.SqlCommand mapdetails = new System.Data.SqlClient.SqlCommand("Select category,latitude,longitude from Complaints where cid = '" + Session["Complaint_Id"] + "' ", Con);
...
<body>
    ...
    <form runat="server" id="ADMIN_VIEWMAP">
            ...
            <div class="navbar-nav text-uppercase ms-auto py-4 py-md-0">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark text-small shadow">
                            <li><a class="dropdown-item" href='<%= Url.Action("adminview_complaintpage", "WEP") %>'>View COMPLAINTS</a></li>
                        </ul>
                    </div>
