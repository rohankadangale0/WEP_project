...
<body>
    ...
    <section class="container-fluid pt-5  overflow-hidden">
        ...
        <div class="row gy-5 justify-content-around">
            ...
            <div class="col-xxl-3 col-xl-3 .col-lg-3 .col-md-2 bg-warning mx-3">
            ...
            <div class="col-xxl-3 col-xl-3 .col-lg-3 .col-md-2 bg-success mx-3">
                <div class="container text-center">
            ...
            <div class="col-xxl-3 col-xl-3 .col-lg-3 .col-md-2 bg-primary mx-3">
                <div class="container text-center">
