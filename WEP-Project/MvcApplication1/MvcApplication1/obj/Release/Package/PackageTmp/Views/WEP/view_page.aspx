            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="team-member">
                        <img class="mx-auto rounded-circle" src="../../Content/assets/img/Developer_Profile/pushkar.jpg" alt="Pushkar" />
                        <h4>Pushkar Gosavi</h4>
                        <p class="text-muted">Lead Designer</p>
                        
                        <a class="btn btn-dark btn-social mx-2" href="https://www.facebook.com/gosavi.pushkar18/" aria-label="Pushkar Gosavi Facebook Profile"><i
                                class="fab fa-facebook-f"></i></a>
                        <a class="btn btn-dark btn-social mx-2" href="https://www.instagram.com/gosavi_pushkar18/" aria-label="Pushkar Gosavi Instagram Profile"><i
                                class="fab fa-instagram"></i></a>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="team-member">
                        <img class="mx-auto rounded-circle" src="../../Content/assets/img/Developer_Profile/Anis.jpg" alt="ANIS" />
                        <h4>Anis Ahmed</h4>
                        <p class="text-muted">Lead Marketer</p>
                        
                        <a class="btn btn-dark btn-social mx-2" href="https://www.facebook.com/anisahmed33483903/"
                            aria-label="Anis Ahmed Facebook Profile"><i class="fab fa-facebook-f"></i></a>
                        <a class="btn btn-dark btn-social mx-2" href="https://www.instagram.com/anis_shaikh18/"
                            aria-label="Anis Ahmed LinkedIn Profile"><i class="fab fa-instagram"></i></a>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="team-member">
                        <img class="mx-auto rounded-circle" src="../../Content/assets/img/Developer_Profile/Rohan.jpeg" alt="Rohan" />
                        <h4>Rohan Kadangale</h4>
                        <p class="text-muted">Lead Developer</p>
                        
                        <a class="btn btn-dark btn-social mx-2" href="#!" aria-label="Rohan Kadangale Facebook Profile"><i
                              class="fab fa-facebook-f"></i></a>
                        <a class="btn btn-dark btn-social mx-2" href="#!" aria-label="Rohan Kadangale LinkedIn Profile"><i
                                class="fab fa-instagram"></i></a>
                    </div>
                </div>
                ...
                <div class="col-lg-3">
                    <div class="team-member">
                        <img class="mx-auto rounded-circle" src="../../Content/assets/img/Developer_Profile/Vaibhav.jpeg" alt="Vaibhav" />
                        <h4>Vaibhav Kamath</h4>
                        <p class="text-muted">Lead Developer</p>
                        
                        <a class="btn btn-dark btn-social mx-2" href="#!" aria-label="Vaibhav Kamath Facebook Profile"><i
                                class="fab fa-facebook-f"></i></a>
                        <a class="btn btn-dark btn-social mx-2" href="#!" aria-label="Vaibhav Kamath LinkedIn Profile"><i
                                class="fab fa-instagram"></i></a>
                    </div>
                </div>
            </div>
    ...
    <section class="page-section" id="contact">
        <div class="container">
            ...
            <form runat="server" id="contactForm">
                ...
                <!-- Submit Button-->
                <div class="text-center"><button class="btn btn-warning btn-xl text-uppercase bg-warning disabled"
