     ...
     <!-- Navigation-->
            ...
            <div class="container p-5 bg-dark">
              <h2>ADMIN LOGIN</h2>
                ...
                <form runat="server" name="adminlogin" id="adminlogin" class="was-validated"> 
                <div class="mb-3 mt-3">
                ...
                <div class="mb-3">
                  ...
                  <input type="password" class="form-control" id="pswd" placeholder="Enter password" name="pswd" pattern = "([#!@$%^&*[]-_{}=]*[A-Za-z0-9]{1,}[[#!@$%^&*[]-_{}=]*[0-9]*){8,}" title="Please Enter in format Jhon@2121" required>
                  <div class="valid-feedback">Valid.</div>
                  <div class="invalid-feedback">Please fill out this field.</div>
                </div>
              ...
              <p class="mt-3">Don't Remember Password? <a href='<%= Url.Action("admin_forgotpassword", "WEP") %>'>Forgot Password</a></p>
              <p>Don't have an account? <a href='<%= Url.Action("admin_signuppage", "WEP") %>'>Sign up</a></p>
            </form>
            </div>
