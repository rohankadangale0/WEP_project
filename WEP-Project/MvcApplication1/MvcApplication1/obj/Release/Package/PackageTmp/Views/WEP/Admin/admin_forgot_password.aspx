   ...
   <!-- Navigation-->
            ...
            <div class="container p-5 bg-dark">
              <h2>ADMIN FORGOT PASSWORD</h2>
                ...
                <form runat="server" name="Admin_Forgot_Password" id="Admin_Forgot_Password" class="was-validated">
              ...
              <p class="mt-3">Don't have an account?  <a href='<%= Url.Action("admin_signuppage", "WEP") %>'>SignUp</a></p>

              <p>Already have an account? <a href='<%= Url.Action("admin_loginpage", "WEP") %>'>Login</a></p>
            </form>
            </div>
