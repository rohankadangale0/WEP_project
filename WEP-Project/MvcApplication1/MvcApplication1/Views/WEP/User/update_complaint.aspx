  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <script runat="server">
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            System.Data.SqlClient.SqlCommand complaint = new System.Data.SqlClient.SqlCommand("Select * from Complaints where cid = '" + Session["Complaint_Id"] + "' and uid = '" + Session["ID"].ToString() + "' ", Con);
            ...
            myReader = complaint.ExecuteReader();
            
            while (myReader.Read())
            {
                ccid.Value = myReader["cid"].ToString();
                fname.Value = myReader["fname"].ToString();
                lname.Value = myReader["lname"].ToString();
                phone.Value = myReader["phone"].ToString();
                address.Value = myReader["address"].ToString();
                desc.Value = myReader["description"].ToString();
            }
...
<body>
  ...
  <div class="mainform">
    ...
    <form runat="server" id="Update_ComplaintForm" name="Update_ComplaintForm">
      ...
      <div class="header">
        <h1><b>Update Complaint Form</b></h1>
      ...
      <br><br>
        ...
        <div class="form-group"  hidden="hidden">
            <label for="Complaint ID"><b>COMPLAINT ID:</b></label>
            <input type="text" class="form-control" id="ccid" placeholder="Complaint ID" name="ccid" required runat="server">
        </div>
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="fname" placeholder="Enter first name" name="fname" required runat="server">
      </div>
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="lname" placeholder="Enter last name" name="lname" required runat="server">
      </div>
      ...
      <div class="form-group">
        ...
        <input type="text" id="phone" class="form-control" placeholder="Enter Landline Number" name="phone" maxlength="10" pattern ="[0-9]{10}" title="Please Enter 10 Digits Number" required runat="server" >
      </div>
      ...
      <div class="form-group">
        ...
        <input type="text" id="address" class="form-control" placeholder="Enter Address" name="address" required runat="server">
      </div>
      ...
      <select id="category" name="category" onchange="getcategory(this.value); getcolor(this.value)" runat="server">
        <option value="----">----</option>
      ...
      <br>
       ...
       <select id="water" name="water" class="whidden" onchange="gettypevalue(this.value)" runat="server">
         <option value="----">----</option>
      ...
      <select id="electricity" name="electricity" class="ehidden" onchange="gettypevalue(this.value)" runat="server">
        <option value="----">----</option>
      ...
      <select id="road" name="road" class="rhidden" onchange="gettypevalue(this.value)" runat="server">
        <option value="----">----</option>
      ...
      <!-- <div class="form-group" style="display:none">
        ...
        <input type="text" id="cattype" class="form-control" placeholder="Type Value" name="cattype" style="display:none" runat="server">

      <!-- Complaint Details-->

      <label for="Description"><b>Complaint Details:</b></label>
      <textarea id="desc" name="desc" placeholder="Enter your complaint details......."
        style="height:200px" required runat="server"></textarea>
      <br>
