...
<head runat="server">
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <script runat="server">
        ...
        public string ssn_name { get; set; }
...
<body>
  ...
  <div class="mainform">
    ...
    <form runat="server" id="ComplaintForm" name="ComplaintForm">
      ...
      <!-- Selection Location-->
      <div id="mapsection">
        <label for="subject"><b>Selected Location on Map</b> <br> <span style="color: #cd6432"> If problem is not in current marked area, then you can drag the marker to mark where the problem exist. </span> </label>
