...
<body class="bg">
        ...
        <asp:DataList ID="DataList1" runat="server" >
                ...
                <HeaderTemplate>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <p class="fw-normal mb-1" id="cmpid"><%#Eval("cid") %></p>
                            </td>
                            ...
                            <td>
                                ...
                                <button class="btn btn-link btn-sm btn-rounded" type="submit" name="deleteid" id="deleteid" value='<%#Eval("cid")%>' onclick="delete_record()"> Delete </button> 
                            </td>
                        </tr>
                         </tbody>
                            </ItemTemplate>
    ...
    <!--https://stackoverflow.com/questions/48379818/reading-data-from-html-table-using-javascript -->

    <script>
        function delete_record()
        {
            alert("Are you sure you want to delete this Complaint?\nOnce its deleted cannot be Undone.\nPress OK to delete\nElse refresh the page to Undo delete ");
        }
